...
# GBIF Hosted Portal: Living Norway

This Jekyll website, **https://data.livingnorway.no/**, makes use of a theme and biodiversity widgets developed by the GBIF network.
